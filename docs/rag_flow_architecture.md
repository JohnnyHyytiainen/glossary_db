...
```text
RAG (Retrieval-Augmented Generation) låter krångligt, men som Data Engineer handlar det egentligen bara om att ge en LLM (Gemini) ett väldigt specifikt, öppet lexikon innan den får svara på frågor.
